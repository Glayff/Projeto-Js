        ...
        document.body.innerHTML += `A segunda letra do seu nome é: ${letras[1]} <br />`;
        document.body.innerHTML += `O primeiro índice da letra ${primeiraLetra} do seu nome é ${primeiroIndice} <br />`;
        document.body.innerHTML += `O último índice da letra ${ultimaLetra} do seu nome é ${ultimoIndice}<br /br />`;
